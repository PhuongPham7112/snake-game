...
icon = pygame.image.load(os.path.join(filepath, 'Pictures_for_snake\heart-pixel-art.png'))
img = pygame.image.load(os.path.join(filepath,'Pictures_for_snake\output-onlinepngtools.png'))
apple_img = pygame.image.load(os.path.join(filepath,'Pictures_for_snake\output-onlinepngtools (1).png'))
